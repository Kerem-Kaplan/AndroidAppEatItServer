...
import dev.krm.androidappeatitserver.Model.Food;
import dev.krm.androidappeatitserver.ViewHolder.FoodViewHolder;
        ...
        alertDialog.setPositiveButton("YES", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (newFood != null) {
                    ...
                    Snackbar.make(rootLayout, "New category " + newFood.getName().toString() + "was added", Snackbar.LENGTH_SHORT).show();
                }
            }
        });
